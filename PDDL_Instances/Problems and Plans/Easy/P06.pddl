;; Genearated with: generator.py single-source-move-to-locations --random-seed 20 2 8 6 1.3 Problems/PE03.pddl Problems/PE03.plan
;; Random seed: 20
(define (problem recharge-single-source-move-to-locations-1091)
