;; Genearated with: generator.py single-source-move-to-locations --random-seed 20 3 7 3 1.2 Problems/PM02.pddl Problems/PM02.plan
;; Random seed: 20
(define (problem recharge-single-source-move-to-locations-4931)
...
(:objects
  ...
  battery-0000 battery-0001 battery-0002 battery-0003 battery-0004 battery-0005 battery-0006 battery-0007 battery-0008 battery-0009 battery-0010 battery-0011 - battery-level
)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
