;; Genearated with: generator.py covers 3 2 2 6 15 1.35 problems/m2.pddl problems/m2.plan --random-seed 140
;; Random seed: 140
(define (problem recharging-robots-cover-robots3-areas2-140-1448)
...
(:init
  ...
  (CONNECTED location-0030 location-0036)
