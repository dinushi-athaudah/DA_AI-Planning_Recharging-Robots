...
(:init
  ...
  (battery robot-01 battery-0012)
  (at robot-02 location-0012)
  (battery robot-02 battery-0004)

)
(:goal
  (and
    (at robot-00 location-0014)
